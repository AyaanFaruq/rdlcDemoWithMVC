...
namespace rdlcDemo {
    ...
    public partial class PractiseDbDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string Email, string Address, string Salary) {
...
namespace rdlcDemo.PractiseDbDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Employees] ([Name], [Email], [Address], [Salary]) VALUES (@Name, @Em" +
                "ail, @Address, @Salary)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Employees] SET [Name] = @Name, [Email] = @Email, [Address] = @Address, [S" +
                "alary] = @Salary WHERE (([Id] = @Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, Name, Email, Address, Salary\r\nFROM            Employees";
        ...
        public virtual int Fill(PractiseDbDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual PractiseDbDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PractiseDbDataSet.EmployeesDataTable dataTable = new PractiseDbDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PractiseDbDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Insert(string Name, string Email, string Address, string Salary) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string Address, string Salary, int Original_Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
